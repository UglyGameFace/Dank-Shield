...
def main() -> int:
    parser = argparse.ArgumentParser(description="Audit raw picker usage that should migrate to stoney_verify.ui.")
    parser.add_argument("--fail", action="store_true", help="Exit 1 when raw picker usage is found.")
