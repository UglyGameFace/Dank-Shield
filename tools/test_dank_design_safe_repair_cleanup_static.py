...
def test_active_public_flow_does_not_replace_design_functions_or_classes() -> None:
    ...
    # Legacy implementation can remain as a backend during this migration, but
    # public routing no longer depends on its historical enhancement patch layer.
...
if __name__ == "__main__":
    for test in (
        ...
        test_active_public_flow_does_not_replace_design_functions_or_classes,
    ):
        test()
