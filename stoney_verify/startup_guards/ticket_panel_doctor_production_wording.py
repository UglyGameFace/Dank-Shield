...
def apply() -> bool:
    ...
    return bool(epoch_ok and confirm_ok and identity_ok and voice_notice_ok and controls_ok and action_refresh_ok and repair_ok and doctor_ok and setup_ok)
