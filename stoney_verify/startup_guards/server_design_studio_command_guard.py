...
def _exact_format_embed(guild: discord.Guild, *, scope: str, target_id: int, lock: Mapping[str, Any]) -> discord.Embed:
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "**3. Press Save & Preview.** This saves the rule and opens a preview.\n"
    ...
    embed.set_footer(text="Save & Preview saves the rule first. Nothing is renamed until the preview screen shows Apply.")
    return _clean_design_embed(embed)
