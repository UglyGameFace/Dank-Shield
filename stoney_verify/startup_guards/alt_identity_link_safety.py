...
This replaces the old root-level runtime_alt_identity_link_safety_patch.py.
...
This guard does not add paid/intelligence-network data. It only makes the bot's
...
def _log(message: str) -> None:
    try:
        print(f"🔗 alt_identity_link_safety {message}")
    except Exception:
        pass
