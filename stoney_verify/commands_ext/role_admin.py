...
def register_role_admin_commands(bot, tree) -> None:
    ...
    async def verify_diagnose_slash(
        ...
        embed.add_field(
            name="Unverified",
            value="YES" if (unverified_role and unverified_role in user.roles) else "NO",
            inline=True,
        )
        embed.add_field(
            name="Verified",
            value="YES" if (verified_role and verified_role in user.roles) else "NO",
            inline=True,
        )
        embed.add_field(
            name="Resident",
            value="YES" if (resident_role and resident_role in user.roles) else "NO",
            inline=True,
        )
        embed.add_field(
            name="Staff",
            value="YES" if (staff_role and staff_role in user.roles) else "NO",
            inline=True,
        )
        embed.add_field(
            name="Needs Verification",
            value="YES" if _member_needs_verification(user) else "NO",
            inline=True,
        )
        embed.add_field(
            name="Open Ticket",
    ...
    async def verify_status_slash(
        ...
        has_uv = bool(unverified_role and unverified_role in user.roles)
