...
def _choice_preview_embed(guild: discord.Guild, choice: PlainSetupChoice) -> discord.Embed:
    ...
    embed.add_field(
        name="Next",
        value=(
            "Choose the features you want, then press "
            "**Continue Guided Setup**."
            if custom
            else "Continue Guided Setup. Dank Shield will "
            "show one required item at a time."
        ),
        inline=False,
    )
...
class PlainSetupHomeView(discord.ui.View):
    ...
    @discord.ui.button(
        ...
        emoji="▶️",
        style=discord.ButtonStyle.success,
        custom_id="dank_setup_plain:continue",
        row=0,
    )
    ...
    @discord.ui.button(
        ...
        emoji="🩺",
        style=discord.ButtonStyle.primary,
        custom_id="dank_setup_plain:health",
        row=0,
    )
    async def health(
        self,
    ...
    @discord.ui.button(
        ...
        emoji="🧪",
        style=discord.ButtonStyle.secondary,
        custom_id="dank_setup_plain:launch",
        row=1,
    )
    async def launch(
        self,
        ...
        embed = discord.Embed(
            title="🧪 Test / Launch",
            description=(
                "Use this after Setup Check passes. "
                "Test with an alt before real members."
            ),
    ...
    @discord.ui.button(
        ...
        emoji="⚙️",
        style=discord.ButtonStyle.secondary,
        custom_id="dank_setup_plain:manage",
        row=1,
    )
    async def manage(
        self,
...
class PlainContinueSetupView(solid.BackToSetupView):
    @discord.ui.button(
        ...
        emoji="➡️",
        style=discord.ButtonStyle.success,
        custom_id="dank_setup_plain_continue:guided",
        row=0,
    )
    async def guided(
        self,
    ...
    @discord.ui.button(
        ...
        emoji="🧭",
        style=discord.ButtonStyle.secondary,
        custom_id="dank_setup_plain_continue:choose",
        row=0,
    )
    async def choose(
        self,
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                "Custom Setup opens feature choices."
            ),
            color=discord.Color.blurple(),
            timestamp=now_utc(),
        )

        for choice in _choices_for_guild(
            interaction.guild
        ):
            embed.add_field(
    ...
    @discord.ui.button(
        ...
        emoji="⚙️",
        style=discord.ButtonStyle.secondary,
        custom_id="dank_setup_plain_continue:advanced",
        row=1,
    )
    async def advanced(
        self,
...
class AfterChoiceView(solid.BackToSetupView):
    """Backward-compatible view that now enters guided setup."""

    @discord.ui.button(
        label="Continue Guided Setup",
        emoji="➡️",
        style=discord.ButtonStyle.success,
        custom_id="dank_setup_after_choice:guided",
        row=0,
    )
    async def guided(
        self,
    ...
    @discord.ui.button(
        ...
        emoji="🩺",
        style=discord.ButtonStyle.primary,
        custom_id="dank_setup_after_choice:health",
        row=0,
    )
    async def health(
        self,
