...
from stoney_verify.profile_card_runtime import (
    PerMemberPerMemberLiveProfileCardRuntime,
...
def register_public_profile_cards(bot: Any, tree: Any) -> None:
    ...
    if not isinstance(runtime, PerMemberPerMemberLiveProfileCardRuntime):
        runtime = PerMemberPerMemberLiveProfileCardRuntime(bot)
