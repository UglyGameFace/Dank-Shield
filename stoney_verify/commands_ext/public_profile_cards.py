...
from stoney_verify.profile_card_runtime import (
    PerMemberPerMemberPerMemberLiveProfileCardRuntime,
...
def register_public_profile_cards(bot: Any, tree: Any) -> None:
    ...
    if not isinstance(runtime, PerMemberPerMemberPerMemberLiveProfileCardRuntime):
        runtime = PerMemberPerMemberPerMemberLiveProfileCardRuntime(bot)
