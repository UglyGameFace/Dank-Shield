...
COMMAND_MODULES: List[CommandModuleSpec] = [
    ...
    ("public_member_lifecycle_runtime", "register_public_member_lifecycle_runtime", "core: authoritative member join/leave log runtime"),
    ...
    ("public_share_router", "register_public_share_router", "core: private mobile share proxy runtime and menu UI"),
