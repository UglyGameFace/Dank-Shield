...
COMMAND_MODULES: List[CommandModuleSpec] = [
    ...
    ("public_setup_category_seed_guard", "register_public_setup_category_seed_guard", "robust recommended ticket menu seeding"),
...
_PUBLIC_CORE_MODULES: Tuple[str, ...] = (
    ...
    "public_spam_cleanup_hardening", "public_setup_solid", "public_setup_category_seed_guard", "public_setup_recommend",
    "public_setup_recovery", "public_setup_cleanup", "public_setup_fresh_choice", "public_status_reporter", "public_modlog_coverage",
