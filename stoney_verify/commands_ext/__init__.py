...
COMMAND_MODULES: List[CommandModuleSpec] = [
    ...
    ("ticket_sla_admin", "register_ticket_sla_admin_commands", "ticket SLA commands"),
    ("ticket_resolution_admin", "register_ticket_resolution_admin_commands", "ticket resolution commands"),
